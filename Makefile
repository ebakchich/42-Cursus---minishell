...
#    Updated: 2023/03/03 08:26:20 by yoyahya          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LBFT	= libft/libft.a
CC		= cc -g
FLAGS  = -Wall -Wextra -Werror -lreadline -L /Users/ebakchic/homebrew/Cellar/readline/8.2.1/lib -I /Users/ebakchic/homebrew/Cellar/readline/8.2.1/include -fsanitize=address
MAKEC	= make clean
MAKEF	= make fclean
MAKER	= make re
